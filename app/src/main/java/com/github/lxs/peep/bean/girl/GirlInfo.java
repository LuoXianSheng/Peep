...
public class GirlInfo implements Parcelable {
     ...
     * children_vote :
     * dislike_num :
     * image_url : http://g.hiphotos.baidu.com/image/pic/item/5243fbf2b21193130e676fb067380cd791238d8e.jpg
     * image_width : 540
     * image_height : 816
     * download_url : http://g.hiphotos.baidu.com/image/pic/item/5243fbf2b21193130e676fb067380cd791238d8e.jpg
     * thumbnail_url : http://imgt8.bdstatic.com/it/u=2,816126398&fm=25&gp=0.jpg
     * thumbnail_width : 230
     * thumbnail_height : 347
     * thumb_large_width : 310
     * thumb_large_height : 468
     * thumb_large_url : http://imgt6.bdstatic.com/it/u=2,816126398&fm=19&gp=0.jpg
     * site_name :
     * site_logo :
     * site_url : http://huaban.com
     * from_url : http://huaban.com/pins/38751147/
     * obj_url : http://img.hb.aicdn.com/beb6246c71932198698d1fe846562109441f3ebe1fabe-1c0NJp
     * share_url : http://g.hiphotos.baidu.com/image/s%3D550%3Bc%3Dwantu%2C8%2C95/sign=b2ed949dc9ef7609380b999a1ee6c0f1/5243fbf2b21193130e676fb067380cd791238d8e.jpg?referer=590835df74c6a7efe0319d16eb84
     * download_num : 0
     * collect_num : 0
     * start_index : 2
     * return_number : 5
    ...
    public String toString() {
        return "GirlInfo{" +
                ...
                ", dress_id='" + dress_id + '\'' +
                ", fushi_obj_num='" + fushi_obj_num + '\'' +
                ", fushi_obj_array='" + fushi_obj_array + '\'' +
                ", dress_buy_link='" + dress_buy_link + '\'' +
                ", dress_price='" + dress_price + '\'' +
                ", dress_tag='" + dress_tag + '\'' +
                ", dress_num='" + dress_num + '\'' +
                ", dress_discount='" + dress_discount + '\'' +
                ", dress_other='" + dress_other + '\'' +
                ", dress_extend_type='" + dress_extend_type + '\'' +
                ", dress_extend_name='" + dress_extend_name + '\'' +
                ", children_vote='" + children_vote + '\'' +
                ...
                ", album_di='" + album_di + '\'' +
                ", can_album_id='" + can_album_id + '\'' +
                ", album_obj_num='" + album_obj_num + '\'' +
                ", user_id='" + user_id + '\'' +
                ", app_id='" + app_id + '\'' +
                ", colum='" + colum + '\'' +
                ", photo_id='" + photo_id + '\'' +
