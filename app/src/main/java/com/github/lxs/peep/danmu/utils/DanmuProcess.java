package com.github.lxs.peep.danmu.utils;
...
import com.github.lxs.peep.danmu.client.DyBulletScreenClient;
import com.github.lxs.peep.utils.BiliDanmukuParser;
...
public class DanmuProcess {
    ...
    private Integer maxLinespair = 6;

    public DanmuProcess(Context context, IDanmakuView danmakuView, int roomId, int maxLinespair) {
        this.mContext = context;
        this.mDanmakuView = danmakuView;
        this.mRoomId = roomId;
        this.maxLinespair = maxLinespair;
        random = new Random();
    }
    ...
    private void initDanmaku() {
        ...
        maxLinesPair.put(BaseDanmaku.TYPE_SCROLL_LR, maxLinespair);
